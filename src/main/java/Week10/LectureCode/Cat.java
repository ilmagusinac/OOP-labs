...
class ReflectionMain {
    public static void main(String[] args) throws IllegalAccessException, InvocationTargetException {
        ...
        for (Field field : catFields) {
            if (field.getName().equals("name")) { //we can change the value of the private final variable
                field.setAccessible(true); // You have to handle IllegalAccessException the exception that could be thrown

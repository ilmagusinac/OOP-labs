...
//logic that will automatically run the method with previously created annotation
        //if we run this code we will see that the method called saySomething will be runned by the program written
